...
void newITClassA( struct ITClassA* self )
{
	...
	cclass_set_cvtable(self, ITClassA_VTable_Key( ));
	
	/* Construct inherited interfaces */
	/* This must be third thing done in constructor. */
	cinterface_init(self, &self->itInterface2, &ITClassA_VTable_Key( )->ITInterface2_VTable);
	cinterface_init(self, &self->itInterface1, &ITClassA_VTable_Key( )->ITInterface1_VTable);
	cinterface_init(self, &self->itInterface1.itInterface0, &ITClassA_VTable_Key( )->ITInterface1_VTable.ITInterface0_VTable);
}
...
static int ITInterface0_ClassB_Method0( struct ITInterface0* self_ )
{
	...
	return IT_CLASSB_I0_METHOD0 + ((struct ITClassB_VTable*) cclass_get_vtable(self))->Supers_ITClassA_VTable->ITInterface1_VTable.ITInterface0_VTable.i0method0(&self->classA.itInterface1.itInterface0);
}
...
static int ITInterface2_ClassB_Method0( struct ITInterface2* self_ )
{
	...
	/* Return sum of this macro plus value returned by super's implementation. */
	return IT_CLASSB_I2_METHOD0 + ((struct ITClassB_VTable*) cclass_get_vtable(self))->Supers_ITClassA_VTable->ITInterface2_VTable.i2method0(&self->classA.itInterface2);
}
...
void newITClassB( struct ITClassB* self )
{
	...
	newITClassA(&self->classA);
        ...
        cinterface_init(self, &self->classA.itInterface2, &ITClassB_VTable_Key()->ITClassA_VTable.ITInterface2_VTable);
        cinterface_init(self, &self->classA.itInterface1.itInterface0, &ITClassB_VTable_Key()->ITClassA_VTable.ITInterface1_VTable.ITInterface0_VTable);
        
	/* Map vtable. */
	/* Must be second thing done in constructor. */
	cclass_set_cvtable(self, ITClassB_VTable_Key( ));
}
...
static int ITInterface0_ClassC_Method0( struct ITInterface0* self_ )
{
	...
	/* Return sum of this macro plus value returned by super's implementation. */
	return IT_CLASSC_I0_METHOD0 + ((struct ITClassC_VTable*) cclass_get_vtable(self))->Supers_ITClassB_VTable->ITClassA_VTable.ITInterface1_VTable.ITInterface0_VTable.i0method0(&self->classB.classA.itInterface1.itInterface0);
}
...
static int ITInterface1_ClassC_Method0( struct ITInterface1* self_ )
{
	...
	/* Return sum of this macro plus value returned by super's implementation. */
	return IT_CLASSC_I1_METHOD0 + ((struct ITClassC_VTable*) cclass_get_vtable(self))->Supers_ITClassB_VTable->ITClassA_VTable.ITInterface1_VTable.i1method0(&self->classB.classA.itInterface1);
}
...
static int ITInterface2_ClassC_Method0( struct ITInterface2* self_ )
{
	...
	/* Return sum of this macro plus value returned by super's implementation. */
	return IT_CLASSC_I2_METHOD0 + ((struct ITClassC_VTable*) cclass_get_vtable(self))->Supers_ITClassB_VTable->ITClassA_VTable.ITInterface2_VTable.i2method0(&self->classB.classA.itInterface2);
}
...
void newITClassC( struct ITClassC* self )
{
	...
	newITClassB(&self->classB);
        ...
        cinterface_init(self, &self->classB.classA.itInterface2, &ITClassC_VTable_Key()->ITClassB_VTable.ITClassA_VTable.ITInterface2_VTable);
        cinterface_init(self, &self->classB.classA.itInterface1.itInterface0, &ITClassC_VTable_Key()->ITClassB_VTable.ITClassA_VTable.ITInterface1_VTable.ITInterface0_VTable);
        cinterface_init(self, &self->classB.classA.itInterface1, &ITClassC_VTable_Key()->ITClassB_VTable.ITClassA_VTable.ITInterface1_VTable);
        
	/* Map vtable. */
	/* Must be second thing done in constructor. */
	cclass_set_cvtable(self, ITClassC_VTable_Key( ));
}
