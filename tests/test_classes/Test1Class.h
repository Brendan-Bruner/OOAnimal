 ...
 * 				Done using: method4
 */
#ifndef TESTS_TEST_CLASSES_TEST1CLASS_H_
#define TESTS_TEST_CLASSES_TEST1CLASS_H_
...
struct Test1Class
{
	...
	int (*method0)( struct Test1Class* );
	int (*method1)( struct Test1Class* );
	int (*method2)( struct Test1Class* );
};



#endif /* TESTS_TEST_CLASSES_TEST1CLASS_H_ */
